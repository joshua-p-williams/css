...
export default {
    ...
    computed: {
        ...mapGetters('ParticipantsSingle', ['item', 'loading', 'participantteamsAll', 'categoriesAll'])
    },
    created() {
    ...
    methods: {
        ...mapActions('ParticipantsSingle', ['storeData', 'resetState', 'setTeam', 'setCategory', 'setName', 'setPhone', 'setEmail', 'setAddress', 'fetchParticipantteamsAll', 'fetchCategoriesAll']),
