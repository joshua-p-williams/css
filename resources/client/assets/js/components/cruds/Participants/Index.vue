...
export default {
    data() {
        return {
            ...
            xprops: {
                module: 'ParticipantsIndex',
                route: 'participants',
                permission_prefix: 'participant_'
            }
        }
    },
    created() {
    ...
    computed: {
        ...mapGetters('ParticipantsIndex', ['data', 'total', 'loading', 'relationships']),
    },
    watch: {
        query: {
            handler(query) {
    ...
    methods: {
        ...mapActions('ParticipantsIndex', ['fetchData', 'setQuery', 'resetState']),
    }
}
</script>
