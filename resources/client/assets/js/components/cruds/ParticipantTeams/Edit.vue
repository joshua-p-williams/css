...
export default {
    ...
    methods: {
        ...mapActions('ParticipantTeamsSingle', ['fetchData', 'updateData', 'resetState', 'setName', 'setCategory', 'setPrimary_participant_name', 'setPrimary_participant_phone', 'setPrimary_participant_email', 'setState', 'setCounty']),
        updateName(e) {
