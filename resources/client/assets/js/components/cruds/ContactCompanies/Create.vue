...
export default {
    ...
    methods: {
        ...mapActions('ContactCompaniesSingle', ['storeData', 'resetState', 'setName', 'setCategory', 'setPrimary_contact_name', 'setPrimary_contact_phone', 'setPrimary_contact_email', 'setState', 'setCounty', 'fetchCategoriesAll']),
        updateName(e) {
