...
const actions = {
    ...
    setPrimary_contact_name({ commit }, value) {
        commit('setPrimary_contact_name', value)
    },
    setPrimary_contact_phone({ commit }, value) {
        commit('setPrimary_contact_phone', value)
    },
    setPrimary_contact_email({ commit }, value) {
        commit('setPrimary_contact_email', value)
    },
...
const mutations = {
    ...
    setPrimary_contact_name(state, value) {
        state.item.primary_contact_name = value
    },
    setPrimary_contact_phone(state, value) {
        state.item.primary_contact_phone = value
    },
    setPrimary_contact_email(state, value) {
