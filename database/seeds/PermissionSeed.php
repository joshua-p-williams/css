...
class PermissionSeed extends Seeder
{
    ...
    public function run()
    {
        $items = [
            ...
            ['id' => 70, 'title' => 'contact_management_access',],
            ['id' => 71, 'title' => 'contact_management_create',],
            ['id' => 72, 'title' => 'contact_management_edit',],
            ['id' => 73, 'title' => 'contact_management_view',],
            ['id' => 74, 'title' => 'contact_management_delete',],
            ['id' => 75, 'title' => 'contact_company_access',],
            ['id' => 76, 'title' => 'contact_company_create',],
            ['id' => 77, 'title' => 'contact_company_edit',],
            ['id' => 78, 'title' => 'contact_company_view',],
            ['id' => 79, 'title' => 'contact_company_delete',],
            ['id' => 80, 'title' => 'contact_access',],
            ['id' => 81, 'title' => 'contact_create',],
            ['id' => 82, 'title' => 'contact_edit',],
            ['id' => 83, 'title' => 'contact_view',],
            ['id' => 84, 'title' => 'contact_delete',],
